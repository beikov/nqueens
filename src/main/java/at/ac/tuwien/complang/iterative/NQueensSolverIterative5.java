 ...
 *
 */
public class NQueensSolverIterative5 {
    ...
    private static class StackElement {
        ...
        public StackElement(short col, short row) {
            this.col = col;
            this.row = row;
        }
    }
    
    public NQueensSolverIterative5(int n) {
        this.n = n;
        int i;
    ...
    public static void main(String[] args) {
        ...
        NQueensSolverIterative5 o = new NQueensSolverIterative5(n);
