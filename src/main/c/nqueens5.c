 ...
 * 			(#3) replace integers with chars in the 'struct field' definition
 * 			(#4) reverse ordering in both inner for loops
 * 				But for this also complete queens removal at the end was
 * 				necessary.
 *
 *****************************************************************************/
#include <stdio.h>
